...
<style>
  ...
  <body>
    <!-- Navbar -->
  <nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top" style="background-color: #3db2d9;">
    <div class="container-fluid" style="background-color: #3db2d9;">
  ...
  <!-- End Navbar -->
     ...
     <!-- Table -->
  <div class="container">
        <h2 class="text-center pt-4" style="color :#3db2d9 ;">Transaction History</h2>
